...
class Player {
  ...
  strike(player, enemy, attackDmg) {
    ...
    let damage_Amount = Math.ceil(Math.random() * attackDmg);

    // Subtract the enemy health with the damageAmountqqqqq
    ...
    return `${player.name} attacks ${enemy.name} for ${damage_Amount} damage`;
  }
...
let player1 = new Player("Prabesh", 100, 10);
let player2 = new Player("Anand", 100, 10);
